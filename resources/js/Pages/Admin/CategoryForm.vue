        ...
        <template #header>
            <div class="flex justify-between items-baseline">
                ...
                <div class="flex justify-end">
                    <inertia-link :href="route('admin-categories')" class="btn-header mr-4">Back</inertia-link>
                </div>
            </div>
        </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            store() {
                this.$inertia.post(route('store-category'), this.form, {
                    onSuccess: () => {
                        this.resetForm();
                    },
                    onError: () => {
            ...
            update() {
                this.$inertia.post(route('update-category'), this.form, {
                    onSuccess: () => {
                        this.resetForm();
                    },
                    onError: () => {
            ...
            remove(id) {
                this.$inertia.post(route('delete-category'), { id: id }, {
                    onSuccess: () => {
                        this.resetForm();
                    },
                    onError: () => {
